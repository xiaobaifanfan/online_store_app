...
<!-- 				<view class="sec-header">
				...
				<list-cell icon="icon-shoucang_xuanzhongzhuangtai" iconColor="#54b4ef" title="我的收藏" @eventClick="navTo('/pages/user/fav/fav')"></list-cell>
				<list-cell icon="icon-shezhi1" iconColor="#e07472" title="个人信息" border="" @eventClick="navTo('/pages/userinfo/userinfo')"></list-cell>
				<list-cell icon="icon-pinglun-copy" iconColor="#ee883b" title="个人消息" tips="留言" @eventClick="navTo('/pages/user/message/message')"></list-cell>
			</view>
		</view>
		
		<view class="list-cell log-out-btn" style="background-color: #C0C4CC;border-radius: 20px;width: 70%;margin-left: 15%;" @click="toLogout">
